...
//#define WifiSAPServeur // n'autorise pas la bascule sur le réseau normal si le point d'accès est activé
...
struct param
{
  float zeropince = -0.2;                   // valeur mesurer à zéro (2) 2819 2818.5
  float coeffPince = 0.02367;               // Calculer le coefficient (4)0.14 0.210
